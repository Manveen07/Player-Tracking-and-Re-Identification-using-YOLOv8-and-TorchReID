...
# Custom script to run YOLOv8 object detection on a video file and save annotated frames and video output
...
def run_detection(video_path, model_path, output_dir, output_video_path):
    ...
    while True:
        ...
        results_list = model.predict(source=frame, conf=CONF_THRESHOLD, verbose=False)
